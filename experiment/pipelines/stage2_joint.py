...
from core.pinn.pinn_architecture import (
    FeedForwardNet,
    MultiSigmoidChangepoint,   # new, add to architecture
    PINN,
    physics_residual,
    train_loop,
)

# def run_stage2_joint(t_np, C_meas_np, peak_times, ...):
# def run_stage2(t_np, C_meas_np, t_left, t_right,
#                print_every=500, verbose=True):
#     # full series normalisation
#     # build MultiSigmoidChangepoint with peak_times as tau_inits
#     # train_loop on full series
#     # return all taus, Q_values, S_values
